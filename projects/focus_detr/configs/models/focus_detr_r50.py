...
from projects.focus_detr.modeling import (
    FOCUS_DETR,
    FOCUS_DETRTransformerEncoder,
    FOCUS_DETRTransformerDecoder,
    FOCUS_DETRTransformer,
    FOCUS_DETRCriterion,
)
...
model = L(FOCUS_DETR)(
    ...
    transformer=L(FOCUS_DETRTransformer)(
        encoder=L(FOCUS_DETRTransformerEncoder)(
            embed_dim=256,
            num_heads=8,
