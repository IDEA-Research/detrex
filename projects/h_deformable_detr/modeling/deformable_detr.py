...
class DeformableDETR(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        (
            ...
            multi_level_feats, multi_level_masks, multi_level_position_embeddings, query_embeds,self_attn_mask
        )
        ...
        if self.training:
            ...
            if self.k_one2many > 0:
                loss_dict = self.train_hybrid(
                    output, targets, self.k_one2many, criterion, self.lambda_one2many
                )
            else:
